...
package com.santaba.sitemonitor.util.httpclient.base;

import com.santaba.sitemonitor.util.httpclient.SMHttpClientConnectionOperator;
 ...
 */
@ThreadSafe
public class SMBasicHttpClientConnectionManager implements HttpClientConnectionManager, Closeable {

    private final Log log = LogFactory.getLog(getClass());

    private final SMHttpClientConnectionOperator connectionOperator;
    ...
    public SMBasicHttpClientConnectionManager(
            final Lookup<ConnectionSocketFactory> socketFactoryRegistry,
            final HttpConnectionFactory<HttpRoute, ManagedHttpClientConnection> connFactory,
            final SchemePortResolver schemePortResolver,
            final DnsResolver dnsResolver) {
      this(
          new SMHttpClientConnectionOperator(socketFactoryRegistry, schemePortResolver, dnsResolver),
          connFactory
      );
    }
     ...
     */
    public SMBasicHttpClientConnectionManager(
            final SMHttpClientConnectionOperator httpClientConnectionOperator,
            final HttpConnectionFactory<HttpRoute, ManagedHttpClientConnection> connFactory) {
        super();
    ...
    public final ConnectionRequest requestConnection(
        ...
        return new ConnectionRequest() {
            ...
            public HttpClientConnection get(final long timeout, final TimeUnit tunit) {
                return SMBasicHttpClientConnectionManager.this.getConnection(
                        route, state);
            }
