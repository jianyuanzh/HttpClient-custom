...
/**
 * Refer to DefaultHttpClientConnectionOperator
 ...
 */
@Immutable
public class SMHttpClientConnectionOperator implements HttpClientConnectionOperator {
    ...
    public SMHttpClientConnectionOperator(
