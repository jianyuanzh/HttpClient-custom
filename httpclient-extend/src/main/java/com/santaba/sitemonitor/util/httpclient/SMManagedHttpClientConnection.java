...
import com.santaba.sitemonitor.util.httpclient.base.SMBHttpClientConnection;
...
/**
 * Default {@link ManagedHttpClientConnection} implementation.  refer to DefaultManagedHttpClientConnection
 * @since 4.3
 */
@NotThreadSafe
public class SMManagedHttpClientConnection extends SMBHttpClientConnection
    ...
    public SMManagedHttpClientConnection(
            final String id,
