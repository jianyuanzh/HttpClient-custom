...
import com.santaba.sitemonitor.util.httpclient.SMSessionInputBufferImpl;
 ...
 */
@NotThreadSafe
public class SMBHttpConnectionBase implements HttpConnection, HttpInetConnection {
     ...
     */
    protected SMBHttpConnectionBase(
        ...
        this.inbuffer = new SMSessionInputBufferImpl(inTransportMetrics, buffersize, -1,
